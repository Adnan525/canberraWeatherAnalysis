...
monthTempPlot <- ggplot(result)+
  geom_point(aes(x=Month,y=aveTemp))+
  scale_colour_manual("Values", values = c(min = "blue", mean = "green",max="red"))+
  ylab("Temparature")+
...
# temparature plot
```{r}
ggplot(resultQuarter, aes(x=quarter,y=avTemp))+
  geom_point(size = 5, shape = 23, fill = "red")+
  ylab("Average Temparature")+
  ggtitle("Distribution of the averge temparature from August 2020 to July 2021")
```
